...
def apply_lin_registration(subject_id, output_dir,target_volume,include500):
    ...
    # Make sure FSL's environment variable is set to NIFTI_GZ, otherwise the extension
    # of files generated by flirt might differ from nii.gz
    FSLOUTPUTTYPE=os.environ['FSLOUTPUTTYPE']
    ...
    os.environ['FSLOUTPUTTYPE'] = FSLOUTPUTTYPE # set FSLOUTPUTTYPE back to its original value
